...
def send_record():
    ...
    for row in csvreader:
        ...
        try:
            producer.produce(topic='datatalksclub.yellow_taxi_rides', key=key, value=value)
        except Exception as e:
            print(f"Exception whil producing record value - {value}: {e}")
        else:
            print(f"succesfully producing record value - {value}")
